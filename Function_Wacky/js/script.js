...
if (partyCannon === 10)
 ...
 if (partyCannon === 30) 
	{console.log ("Please stuff 30 cupcakes, 4 cakes, 15 streamers, 8 tables, and a DJ into the party cannon! Have fun with the pony-folk!");
}
 if (partyCannon === 40) 
	{console.log ("Please stuff 40 cupcakes, 6 cakes, 19 streamers, 10 tables, 2 DJs, and the minibar into the party cannon! Have fun with the party!");
}
 if (partyCannon === 50) 
	{console.log ("Please stuff 50 cupcakes, 8 cakes, 20 streamers, 12 tables, the DJ, dance floor, and one full bar into the party cannon! Watch your drink, though....");
}